      ...
      <div className="container">
        <div className="radio-wrapper">
          ...
          <div className="btn">
            ...
            <span aria-hidden="true" className="btn__glitch">Local</span>
        ...
        <div className="radio-wrapper">
          ...
          <div className="btn">
            ...
            <span aria-hidden="true" className="btn__glitch">Online</span>
        ...
        <div className="radio-wrapper">
          ...
          <div className="btn">
            ...
            <span aria-hidden="true" className="btn__glitch">AI</span>
